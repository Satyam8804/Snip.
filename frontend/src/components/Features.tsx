...
const features = [
  {
    ...
    desc: "Links resolve in milliseconds with our optimized infrastructure.",
  },
  {
    icon: "📊",
    name: "Click analytics",
    desc: "Track total clicks, daily trends, and top visitor IPs in real time.",
  },
  {
    icon: "🔒",
    name: "Secure & private",
    desc: "JWT auth, bcrypt passwords, and httpOnly cookies keep you safe.",
  },
  {
    icon: "⏱️",
    name: "Link expiry",
    desc: "Links auto-expire after 30 days. MongoDB TTL handles cleanup.",
  },
  {
    icon: "🎯",
    name: "Custom codes",
    desc: "Base62 generated 6-char codes with collision detection built in.",
  },
  {
    icon: "📋",
    name: "Link dashboard",
    desc: "View, manage and delete all your links in one place.",
  },
];
